...
function greeting(name){return "Hello, " + name}//Code here
...
var newGreeting= function(name){return "Hello, " + name}//Code Here
...
var finalGreeting= (name)=>{return "Hello, " + name}//Code Here
...
function doubleCheck(groceries,string){
  for (i=0; i<groceries.length; i++){
    string = "chocolate"
    if (groceries.includes(string)){}
    else {groceries.push(string)}
  }
  return groceries
}
//Code Here
...
dog.bark= function(){return "Woof woof"}//Code Here
...
function add(num1, num2){return num1+num2}//Code Here
...
function invoker(callback){return callback()}//Code Here
...
function outerFn(){return function innerFn(){return "Shannon"}}//Code Here

//Now save the result of invoking outerFn into a variable called innerFn.

var innerFn= outerFn();//Code Here

var finalResult= innerFn();//Now invoke innerFn and save the result to a variable called finalResult.
